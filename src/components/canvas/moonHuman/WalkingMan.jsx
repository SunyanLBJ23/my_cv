...
Command: npx gltfjsx@6.1.4 .\walkingMan.glb
*/

import React, { useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export function WalkingMan(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/moonMan/walkingMan.glb')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature" scale={100}>
          ...
          <skinnedMesh name="SUIT_DETAILS_SUIT_DETAILS1" geometry={nodes.SUIT_DETAILS_SUIT_DETAILS1.geometry} material={nodes.SUIT_DETAILS_SUIT_DETAILS1.material} skeleton={nodes.SUIT_DETAILS_SUIT_DETAILS1.skeleton} />
        </group>
        <group name="cs_grp">
...
useGLTF.preload('/moonMan/walkingMan.glb')
