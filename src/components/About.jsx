...
const About = () => {
  return (
    <>
      ...
      >
        我熟练使用
        <span className="font-bold" style={{ color: colors.js }}>
          JavaScript
        </span>
        /
        <span className="font-bold" style={{ color: colors.ts }}>
          TypeScript
        </span>
        语言进行日常开发。
        <div>
          ...
          和
          <span className="font-bold" style={{ color: colors.vue }}>
            Vue
          </span>
          框架方面的经验
        </div>
        ...
        <div>
          ...
          /
          <span className="font-bold" style={{ color: colors.express }}>
            express
          </span>
          /
